...
procedure TfraGenericProgramInfo.btnMoreInfoClick(Sender: TObject);
begin
FProgramVersionInfo.OpenSupportSite;
end;
...
if SaveDialog.Execute(Self.Handle) then
   ...
   Try
      ...
      StringList.Add('FileVersion=' + FProgramVersionInfo.FileVersion);
